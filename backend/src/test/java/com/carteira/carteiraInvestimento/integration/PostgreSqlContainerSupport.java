...
abstract class PostgreSqlContainerSupport {
	...
	static void databaseProperties(DynamicPropertyRegistry registry) {
		...
		registry.add("application.broker-catalog.brasil-api-cnpj.url", () -> System.getProperty("broker.test.cnpj.url", System.getProperty("broker.test.url", "http://127.0.0.1:1")));
		registry.add("application.broker-catalog.brasil-api-cvm.url", () -> System.getProperty("broker.test.cvm.url", System.getProperty("broker.test.url", "http://127.0.0.1:1")));
		registry.add("application.broker-catalog.via-cep.url", () -> System.getProperty("broker.test.cep.url", System.getProperty("broker.test.url", "http://127.0.0.1:1")));
	}
}
